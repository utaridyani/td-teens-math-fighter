import Phaser from 'phaser'
 ...
 Phaser.Scene
 {
    ...
    create(){
        ...
        this.enemy = this.physics.add.sprite(this.gameHalfWidth+150, this.gameHalfHeight-200, "enemy").setOffset(20,-10).setBounce(0.2).setFlipX(true);
    ...
    createButtons() {
      ...
      addNumber(pointer, object, event){
        ...
        // INGAT CONVERT KE TO STRING DULU
